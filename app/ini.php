...
function buurthaven_amsterdams_enqueues() {
	...
	wp_enqueue_style( 'buurthanven.amsterdam-general', get_stylesheet_directory_uri() . '/dist/styles/buurthaven.combined.css', [], filetime(__DIR__ . '/../dist/styles/buurthaven.combined.css'), 'all' );
}
